...
export const COMMAND_DESCRIPTIONS: Record<string, CommandDescription> = {
  ...
  [VALORANT_RANK_KEY]: noArguments('mostrar el rango actual de Valorant'),
  [VALORANT_RANK_ALIAS_KEY]: noArguments('mostrar el rango actual de Valorant'),
  [VALORANT_ELO_KEY]: noArguments('mostrar el rango actual de Valorant'),
  [VALORANT_RANK_ALIAS_2_KEY]: noArguments('mostrar el rango actual de Valorant'),
  [VALORANT_KEY]: noArguments('mostrar el rango actual de Valorant'),
  [VALORANT_ID_ALIAS_KEY]: noArguments('mostrar el rango actual de Valorant'),
  [CROSSHAIR_KEY]: noArguments('mostrar la configuración de la mira'),
  [LAST_RANKED_KEY]: noArguments('mostrar el resultado de la última partida ranked'),
  [LAST_RANKED_ALIAS_KEY]: noArguments('mostrar el resultado de la última partida ranked'),
  [LAST_GAME_KEY]: noArguments('mostrar el resultado de la última partida ranked'),
  ...
  [PLAYERS_LIST_KEY]: noArguments('mostrar la lista de jugadores y sus prioridades'),
  [PLAYERS_LIST_ALIAS_KEY]: noArguments('mostrar la lista de jugadores y sus prioridades'),
  [HOW_TO_PLAY_KEY]: noArguments('mostrar cómo unirse a la partida'),
  ...
  [ADD_TO_PLAYERS_QUEUE_KEY]: noArguments('sumar al usuario que lo pide a la lista para jugar'),
  [ADD_TO_PLAYERS_QUEUE_KEY_ALIAS]: noArguments('sumar al usuario que lo pide a la lista para jugar'),
