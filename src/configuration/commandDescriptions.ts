...
export const COMMAND_DESCRIPTIONS: Record<string, CommandDescription> = {    
  ...
  [CHANGE_CHANNEL_INFORMATION_KEY]: withArguments('cambiar la categoría, título y tags del stream. Categoría obligatoria; título y tags opcionales. Si faltan, usa los valores por defecto. Máximo 140 caracteres en título y 10 tags de hasta 25 caracteres, separados por comas y sin # ni símbolos.', `${CHANGE_CHANNEL_INFORMATION_KEY} CATEGORIA [/ TITULO] [/ TAG1,TAG2,TAGX]`),     
  [CHANGE_CHANNEL_INFORMATION_KEY_2]: withArguments('cambiar la categoría, título y tags del stream. Categoría obligatoria; título y tags opcionales. Si faltan, usa los valores por defecto. Máximo 140 caracteres en título y 10 tags de hasta 25 caracteres, separados por comas y sin # ni símbolos.', `${CHANGE_CHANNEL_INFORMATION_KEY_2} CATEGORIA [/ TITULO] [/ TAG1,TAG2,TAGX]`),   
