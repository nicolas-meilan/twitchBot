...
export const COMMAND_DESCRIPTIONS: Record<string, CommandDescription> = {    
  ...
  [VALORANT_RANK_KEY]: withArguments(`mostrar el rango ACTUAL de Valorant, no el mínimo, ni el máximo. Acepta un usuario#tag de LATAM; si no se indica, consulta al streamer (por defecto: ${DEFAULT_VALORANT_USERNAME}#${DEFAULT_VALORANT_TAG})`, `${VALORANT_RANK_KEY} [usuario#tag]`),    
  [VALORANT_RANK_ALIAS_KEY]: withArguments(`mostrar el rango ACTUAL de Valorant, no el mínimo, ni el máximo. Acepta un usuario#tag de LATAM; si no se indica, consulta al streamer (por defecto: ${DEFAULT_VALORANT_USERNAME}#${DEFAULT_VALORANT_TAG})`, `${VALORANT_RANK_ALIAS_KEY} [usuario#tag]`),    
  [VALORANT_ELO_KEY]: withArguments(`mostrar el rango ACTUAL de Valorant, no el mínimo, ni el máximo. Acepta un usuario#tag de LATAM; si no se indica, consulta al streamer (por defecto: ${DEFAULT_VALORANT_USERNAME}#${DEFAULT_VALORANT_TAG})`, `${VALORANT_ELO_KEY} [usuario#tag]`),    
  [VALORANT_RANK_ALIAS_2_KEY]: withArguments(`mostrar el rango ACTUAL de Valorant, no el mínimo, ni el máximo. Acepta un usuario#tag de LATAM; si no se indica, consulta al streamer (por defecto: ${DEFAULT_VALORANT_USERNAME}#${DEFAULT_VALORANT_TAG})`, `${VALORANT_RANK_ALIAS_2_KEY} [usuario#tag]`),    
  [VALORANT_KEY]: withArguments(`mostrar el rango ACTUAL de Valorant, no el mínimo, ni el máximo. Acepta un usuario#tag de LATAM; si no se indica, consulta al streamer (por defecto: ${DEFAULT_VALORANT_USERNAME}#${DEFAULT_VALORANT_TAG})`, `${VALORANT_KEY} [usuario#tag]`),    
  [VALORANT_ID_ALIAS_KEY]: withArguments(`mostrar el rango ACTUAL de Valorant, no el mínimo, ni el máximo. Acepta un usuario#tag de LATAM; si no se indica, consulta al streamer (por defecto: ${DEFAULT_VALORANT_USERNAME}#${DEFAULT_VALORANT_TAG})`, `${VALORANT_ID_ALIAS_KEY} [usuario#tag]`),    
  [LAST_RANKED_KEY]: withArguments(`mostrar el resultado de la última partida de Valorant (Busca la última Ranked).  Acepta un usuario#tag de LATAM; si no se indica, consulta al streamer (por defecto: ${DEFAULT_VALORANT_USERNAME}#${DEFAULT_VALORANT_TAG})`, `${LAST_RANKED_KEY} [usuario#tag]`),    
  [LAST_RANKED_ALIAS_KEY]: withArguments(`mostrar el resultado de la última partida de Valorant (Busca la última Ranked).  Acepta un usuario#tag de LATAM; si no se indica, consulta al streamer (por defecto: ${DEFAULT_VALORANT_USERNAME}#${DEFAULT_VALORANT_TAG})`, `${LAST_RANKED_ALIAS_KEY} [usuario#tag]`),  
  [LAST_RANKED_2_KEY]: withArguments(`mostrar el resultado de la última partida de Valorant (Busca la última Ranked).  Acepta un usuario#tag de LATAM; si no se indica, consulta al streamer (por defecto: ${DEFAULT_VALORANT_USERNAME}#${DEFAULT_VALORANT_TAG})`, `${LAST_RANKED_2_KEY} [usuario#tag]`),  
  [LAST_GAME_KEY]: withArguments(`mostrar el resultado de la última partida de Valorant (Busca la última Ranked).  Acepta un usuario#tag de LATAM; si no se indica, consulta al streamer (por defecto: ${DEFAULT_VALORANT_USERNAME}#${DEFAULT_VALORANT_TAG})`, `${LAST_GAME_KEY} [usuario#tag]`),  
