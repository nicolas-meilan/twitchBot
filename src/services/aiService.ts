...
const SYSTEM_PROMPT = [
  ...
  'Cuando una pregunta pueda responderse de varias formas correctas, elegí una formulación diferente de manera natural, manteniendo el mismo significado y la personalidad del bot.',
